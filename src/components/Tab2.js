...
function Tab2() {
    ...
    const Tab2API=()=>{
        ...
        .get(
          "https://sheets.googleapis.com/v4/spreadsheets/13oRnrhJDqu1PfymUW13Ibq_b-AVHP2gr3l5RwSPy7VM/values/Team_1!A1:C9/?key=AIzaSyBojSmY8Zvgy8Qw927mK14NHkDy-XJr9iw"
        )
        .then((response) => {
  ...
  return (
    <div className='tab2main mx-0'>
      ...
      <img src={img} alt="Responsive-image" class="img-thumbnail" id='tab2img'/>
      </div>
